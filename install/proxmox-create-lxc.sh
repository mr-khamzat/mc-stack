...
echo -e "  IP адрес:  ${CYAN}${CT_FINAL_IP}${NC}"
echo -e "  Логин:     ${CYAN}root${NC}"
echo -e "  Пароль:    ${YELLOW}${CT_PASSWORD}${NC}   ← сохрани!"
echo -e "${BOLD}└───────────────────────────────────────────────────┘${NC}"
echo ""
echo -e "${BOLD}┌─ Подключение по SSH ──────────────────────────────┐${NC}"
echo -e "  ${GREEN}ssh root@${CT_FINAL_IP}${NC}"
echo -e "  Пароль: ${YELLOW}${CT_PASSWORD}${NC}"
echo -e "${BOLD}└───────────────────────────────────────────────────┘${NC}"
echo ""
echo -e "${BOLD}┌─ Настройка бота (открой в браузере) ─────────────┐${NC}"
echo -e "  ${CYAN}http://${CT_FINAL_IP}/${NC}"
echo -e "${BOLD}└───────────────────────────────────────────────────┘${NC}"
echo ""
echo -e "  Введи токены на странице → бот запустится автоматически"
echo ""
echo -e "${BOLD}┌─ После настройки: Mini App ───────────────────────┐${NC}"
echo -e "  ${CYAN}http://${CT_FINAL_IP}/ha-app/${NC}"
echo -e "${BOLD}└───────────────────────────────────────────────────┘${NC}"
echo ""
echo -e "Войти в контейнер напрямую:"
